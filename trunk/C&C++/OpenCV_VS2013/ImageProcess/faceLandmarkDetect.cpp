...
// ----------------------------------------------------------------------------------------
int faceLandmarkDetect(const string strFile)
#if 1
{
	double t;
	try
	{
		...
		cout << "提取market所用时间：" << t * 1000 / cvGetTickFrequency() << "ms" << endl;
		...
		if (1)
		{
			...
			t = (double)GetTickCount() - t;
			cout << "load image所用时间：" << t * 1000 / cvGetTickFrequency() << "ms" << endl;
			...
			t = (double)GetTickCount() - t;
			cout << "Detect image所用时间：" << t * 1000 / cvGetTickFrequency() << "ms" << endl;
