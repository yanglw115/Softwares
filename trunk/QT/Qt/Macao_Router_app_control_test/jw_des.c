...
********************************************************************************/
int des_encryption(unsigned char* pSrc, unsigned char* pKey, unsigned char* pBuf)  //des º”√‹
{
...
********************************************************************************/
int des_decryption(unsigned char* pSrc, unsigned char* pKey, unsigned char* pBuf)  //des Ω‚√‹
{
	if (NULL == pSrc || NULL == pKey || NULL == pBuf)
	{
		return PARAM_NULL;
