...
typedef std::vector<std::pair<bool, std::vector<std::string>>> vectorPair;
...
class Hanz2Piny 
{
    ...
    public:
        ...
        vectorString toPinyinFromUnicode(const Unicode hanzi_unicode, const bool with_tone = true) const;
        
        bool isUtf8(const std::string& s) const;
        vectorPair toPinyinFromUtf8(const std::string& s, const bool with_tone = true, const bool replace_unknown = false,
